...
function EditPage() {
  ...
  return (
    <div>
        ...
        <div className={classes.section}>
          <div className={classes.header}>Update Photo</div>
          <UploadPhoto snackOpen={snackOpen}/>
        </div>
        <div className={classes.section}>
          <div className={classes.header}>Upload Resume</div>
          <UploadResume snackOpen={snackOpen}/>
        </div>
